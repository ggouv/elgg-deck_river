		...
		elgg.post('ajax/view/deck_river/ajax/user_info', {
			...
			success: function(response) {
				...
				$('#user-info-popup .elgg-tabs > li > a').click(function() {
					...
					if (tab == '#user-info-mention' && $('#user-info-mention .elgg-ajax-loader').length) {
						elgg.deck_river.LoadMention($('#user-info-mention > .elgg-river').attr('data-user'), $('#user-info-popup #user-info-mention'));
					}
				});
			},
			error: function() {
		...
		elgg.post('ajax/view/deck_river/ajax/group_info', {
			...
			success: function(response) {
				...
				$('#group-info-popup .elgg-tabs > li > a').click(function() {
					...
					if (tab == '#group-info-mention' && $('#group-info-mention .elgg-ajax-loader').length) {
						elgg.deck_river.LoadMention($('#group-info-mention > .elgg-river').attr('data-group'), $('#group-info-popup #group-info-mention'));
					}
				});
			},
			error: function() {
