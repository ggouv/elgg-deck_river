...
function deck_river_twitter_authorize() {
	...
	deck_river_twitter_api_revoke(elgg_get_logged_in_user_guid());
 ...
 */
function deck_river_twitter_api_revoke($user_guid, $screen_name = null) {
 ...
 */
function deck_river_twitter_get_account($user_guid = null, $screen_name = null) {
	if (!$user_guid) $user_guid = elgg_get_logged_in_user_guid();

	return elgg_get_entities_from_metadata(array(
		'type' => 'object',
		'subtype' => 'twitter_account',
		'metadata_name' => 'screen_name',
		'metadata_value' => $screen_name,
